...
from isolation import place_pawn
from isolation import check_isolation_victory
...
def start_game(screen, quadrants_data):
    ...
    while running:
        ...
        # Afficher le message de victoire pour Isolation
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if (board_x <= mouse_x < board_x + board_size and 
                    ...
                    if current_game_mode == 2:  # isolationnnnn
